      ...
      <el-row>
        ...
        >
          ...
          >
            <el-form-item
              label="所属门店"
              v-if="this.getUserInfo().bin_id == 1 && operation"
            >
              <el-select
                placeholder="选择所属门店"
                size="medium"
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        { prop: "StoreName", label: "所属店铺", minWidth: 100 },
        { prop: "bzmc", label: "班组", minWidth: 100 },
        { prop: "bzsm", label: "班组说明", minWidth: 150 }
      ]
    };
  },
  mounted() {
