...
<template>
  <div>
    <el-row class="containt">
        ...
        <el-form class="filterBlock" :inline="true" :gutter="20">
          <el-row class="filterContent">
            <el-form-item label="关键字查询">
              <el-input v-model.trim="parameter.Keys" size="medium" clearable placeholder="详细地址/省/市/县/结算卡开户行"></el-input>
            </el-form-item>
            <el-form-item>
      ...
      <el-row>
        <el-col :span="24">
          <el-table ref="multipleTable" :data="tableList" tooltip-effect="dark" stripe @current-change="handleRoleSelectChange">
            <el-table-column v-for="column in columns" header-align="center" align="center" :prop="column.prop" :label="column.label" :width="column.width" :min-width="column.minWidth" :fixed="column.fixed" :key="column.prop" :type="column.type" :formatter="column.change" @handleCurrentChange="handleRoleSelectChange">
            </el-table-column>
        ...
        <el-dialog :title="operation?'新增':'编辑'" width="40%" :visible.sync="dialogVisible" :close-on-click-modal="false">
          <el-form :model="dataForm" label-width="120px" :rules="dataFormRules" ref="dataForm" label-position="right">
            ...
            <el-form-item label="上传营业执照" prop="cus_license">
              <el-upload class="avatar-uploader" :action="this.url + 'CarServer/Store/AddStoreFile'" :show-file-list="false" name="cus_license" :on-success="handleBusinessAvatarScucess" :before-upload="beforeAvatarUpload">
...
export default {
  ...
  methods: {
    ...
    findTreeData: function() {
      ...
      this.post(
        "PubInterface/User/QueryUserMenuList",
