  ...
  <div>
    ...
    <el-row class="containt">
      ...
      <el-row>
        ...
        <!--客户车辆信息界面-->
        <el-dialog title="客户车辆详情" width="50%" :visible.sync="carVisible" :close-on-click-modal="false">
        ...
        <!--客户车辆信息界面-->
        <el-dialog title="客户图片详情" width="40%" :visible.sync="imgVisible" :close-on-click-modal="false">
