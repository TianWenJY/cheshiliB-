<template>
  <div>
    ...
    <el-row class="containt">
        ...
        <el-row class="filterContent">
          <el-form-item label="所属门店" v-if="this.getUserInfo().bin_id == 1">
            <el-select placeholder="选择所属门店" size="medium" v-model="pageRequest.p_id">
              ...
              <el-option v-for="(shop,index) in shopNameList" :label='shop[1]' :value="shop[0]" :key="index"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item>
          <kt-button label="查询" type="primary" @click="findPage(null)" size="medium" :loading="onLoaidng"/>
          </el-form-item>
          <el-form-item>
      ...
      <!--表格内容栏-->
      <!-- @findPage="findPage" -->
      <kt-table :highlightCurrentRow="true" @findPage="findPage" ref="table" :data="pageResult" :pageRequest="pageRequest" :havePassWord="havePassWord" :columns="columns" :showBatchDelete="false" @handleCurrentChange="handleRoleSelectChange" @resPassword="resPassword" @handleEdit="handleEdit" @handleDelete="handleDelete">
      </kt-table>
      <!-- </el-col> -->
      <!--新增编辑界面-->
        ...
        <el-form :model="dataForm" label-width="80px" :rules="dataFormRules" ref="dataForm" :size="size">
          ...
          <el-form-item label="所属班组">
            <el-select placeholder="选择所属班组" size="medium" v-model="dataForm.bz_id">
              <el-option v-for="(team,index) in teamList" :label='team.bzmc' :value="team.id" :key="index"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="开单通知" prop="delivery">
            <el-switch v-model="dataForm.kdtz" active-color="#13ce66" inactive-color="#ff4949" active-value="2" inactive-value="1" active-text="开启" inactive-text="关闭"></el-switch>
          </el-form-item>
          <el-form-item label="预约通知" prop="delivery">
            <el-switch v-model="dataForm.yytz" active-color="#13ce66" inactive-color="#ff4949" active-value="2" inactive-value="1" active-text="开启" inactive-text="关闭"></el-switch>
          </el-form-item>
      ...
      <div class="menu-container">
        ...
        <el-tree :data="menuData" size="mini" show-checkbox node-key="id" :props="defaultProps" style="width: 100%;pading-top:20px;" ref="menuTree" :render-content="renderContent" :check-strictly="false">
        </el-tree>
...
export default {
  ...
  methods: {
    ...
    findTreeData: function() {
      ...
      this.post("PubInterface/User/QueryUserMenuList", { mer_id: this.getUserInfo().mer_id }, res => {
        if (res.body.Status == 0) {
