    ...
    <el-row class="containt">
        ...
        <el-form class="filterBlock" :inline="true" :gutter="20">
          <el-row class="filterContent">
            <el-form-item label="社区名称">
              <el-input v-model.trim="parameter.sqmc" size="medium" clearable placeholder="请输入社区名称"></el-input>
            </el-form-item>
            <el-form-item label="物业费金额（元/㎡）">
              <el-input
                v-model.trim="parameter.wAmount"
                size="medium"
                clearable
                placeholder="物业费金额（元/㎡）"
              ></el-input>
      ...
      <el-row>
        ...
        >
          ...
          >
            <el-form-item label="社区名称">
              <el-input v-model="dataForm.sqmc" auto-complete="off"></el-input>
            </el-form-item>
            <el-form-item label="社区说明">
              <el-input v-model="dataForm.sqsm" auto-complete="off"></el-input>
            </el-form-item>
            <el-form-item label="停车场名称" prop="park_name" v-if="operation">
              <el-input v-model="dataForm.park_name" auto-complete="off"></el-input>
            </el-form-item>
            <el-form-item label="物业费金额（元/㎡）">
              <el-input v-model="dataForm.wAmount" auto-complete="off"></el-input>
            </el-form-item>
            ...
            <el-form-item label="选择省市县" v-if="operation">
              <el-cascader
                size="large"
                :options="options"
            ...
            <el-form-item label="详细地址" prop="add_detail" v-if="operation">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      columns: [
        { prop: "sqmc", label: "社区名称", minWidth: 150 },
        { prop: "wAmount", label: "物业费金额（元/㎡）", minWidth: 180 },
        ...
        { prop: "sqsm", label: "社区地址", minWidth: 200 },
        { prop: "sqsm", label: "社区说明", minWidth: 200 }
      ]
      // filtersData: [
      //   {
  ...
  methods: {
    ...
    GetList(parameter) {
      ...
      //   this.parameter.addtime = "";
      // }
      this.api("NoSense/CommunityPark/QueryCommunityList", parameter, res => {
      ...
      this.$refs["dataForm"].validate(valid => {
        if (valid) {
          this.$confirm("确认提交吗？", "提示", {}).then(() => {
            ...
            let api;
            if (this.operation) {
              api = "NoSense/CommunityPark/AddCommunityPark";
            } else {
              api = "NoSense/CommunityPark/UpdateCommunity";
            }
    ...
    handleDelete(row) {
      this.$confirm("确认删除选中记录吗？", "提示", {
        ...
        this.api(
          "NoSense/CommunityPark/DelCommunityPark",
          { mer_id: row },
          res => {
            this.GetList(this.parameter);
          }
    ...
    handleRoleSelectChange(val) {
      ...
      this.selectName = this.selectStaff.sqmc;
      this.post(
